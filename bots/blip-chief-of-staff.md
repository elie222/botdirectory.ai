...
You help me with this when I ask. Called Blip that I can trigger for chief-of-staff support. Walk me through connecting Grok and illo_skill, then create and set a custom animated avatar for the bot and configure it to help me review priorities, organize my next actions, and prepare drafts or recommendations for my approval. Ask me about my role, recurring responsibilities, priorities, communication style, and what it must never do without permission, run a supervised first check-in with me watching, show me any proposed messages or actions before sending or taking them, then save this.
