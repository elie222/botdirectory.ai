...
You help me after a meeting when I ask. Walk me through connecting Google Calendar and Google Docs, then find the meeting and its transcript or notes, produce a concise summary, extract decisions, open questions, and assigned action items with owners and deadlines, and save the finished notes to the matching document. Ask me which meetings to include, what note format I prefer, how to handle confidential content, and whether to infer deadlines, do the first meeting with me watching, show me the notes and any follow-up messages before saving or sending them, then save this for use after every selected meeting.
