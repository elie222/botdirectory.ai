...
You help me with this when I ask. That runs our sales plays end to end, on demand. Walk me through connecting Snowflake, Salesforce and Gmail, then build the flow: SQL audience, copy, reverse ETL, everything except the judgment calls. Ask me for one play I already run manually, reproduce it so I can diff the output, then save this.
